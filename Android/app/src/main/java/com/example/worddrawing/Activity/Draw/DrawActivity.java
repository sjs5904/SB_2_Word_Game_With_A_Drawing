package com.example.worddrawing.Activity.Draw;
...
public class DrawActivity extends Activity implements OnClickListener {
    ...
    private Button chatBtn, enterBtn, wordBtn, confirmBtn, guess_btn;
    //sizes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wordBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = serverURL + "changeWord/" + answer + "/" + currRoomID;
        ...
        try {
            json.put(PROTOCOL_PREFIX, DrawingView.TYPE.JOIN.getVal());
        } catch (JSONException e) {
            e.printStackTrace();
        }
                    ...
                    if (protocol.equals(DrawingView.TYPE.CHAT)) {
                        ...
                        if (jsonString.getInt("correct") == 1) {
                            ...
                            if (jsonString.getInt("gameFinished") == 1) {
                                ...
                                Thread.sleep(600);
                                cc.close();
                                Intent back = new Intent(DrawActivity.this, RoomActivity.class);
                                startActivity(back);
                            }
                        }
                    }
